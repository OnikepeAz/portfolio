import me from "../assets/wbdev.png";
// import { Link } from "react-router-dom";

function Home() {
  return (
    <div>
      <article class="pv6 mt3 bt bb b--black-10 ph3 ph4-l">
        <div class="flex flex-column flex-row-ns">
          <div class="w-100 w-60-ns pr3-ns order-2 order-1-ns">
            ...
            <h1 class="f1 athelas mt0 lh-title">AbdulAzeez Onikepe</h1>
            <p class="f4 athelas mt0 ">
              Web Developer|Data Analyst|Tecnichal Support
            </p>
            <p class="f5 f4-l lh-copy athelas">
              A web developer who enjoys taking complex problems and turning
              them into simple and beautiful interface designs
            </p>
          </div>
          <div class="pl3-ns order-1 order-2-ns mb4 mb0-ns w-100 w-40-ns">
            <img src={me} class="db" alt="Dev" />
          </div>
        </div>
      </article>
    </div>
